...
public:
    ...
    QLabel *label_10;
    QSlider *BlobValue_slider;
    QLineEdit *BlobValue_text;
    QWidget *tab_6;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_10->setMinimumSize(QSize(70, 20));
        label_10->setMaximumSize(QSize(70, 20));
        label_10->setAlignment(Qt::AlignCenter);

        horizontalLayout_6->addWidget(label_10);

        BlobValue_slider = new QSlider(layoutWidget);
        BlobValue_slider->setObjectName(QString::fromUtf8("BlobValue_slider"));
        BlobValue_slider->setMinimumSize(QSize(320, 30));
        BlobValue_slider->setMaximumSize(QSize(320, 30));
        BlobValue_slider->setMaximum(255);
        BlobValue_slider->setOrientation(Qt::Horizontal);

        horizontalLayout_6->addWidget(BlobValue_slider);

        BlobValue_text = new QLineEdit(layoutWidget);
        BlobValue_text->setObjectName(QString::fromUtf8("BlobValue_text"));
        BlobValue_text->setMinimumSize(QSize(70, 30));
        BlobValue_text->setMaximumSize(QSize(70, 30));
        BlobValue_text->setAlignment(Qt::AlignCenter);
        BlobValue_text->setReadOnly(true);

        horizontalLayout_6->addWidget(BlobValue_text);
        ...
        gridLayoutWidget_29->setGeometry(QRect(10, 80, 160, 75));
        ...
        radioButton = new QRadioButton(gridLayoutWidget_29);
        radioButton->setObjectName(QString::fromUtf8("radioButton"));

        gridLayout_31->addWidget(radioButton, 1, 0, 1, 1);

        radioButton_2 = new QRadioButton(gridLayoutWidget_29);
        radioButton_2->setObjectName(QString::fromUtf8("radioButton_2"));

        gridLayout_31->addWidget(radioButton_2, 2, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_10->setText(QApplication::translate("MainWindow", "Blob", 0, QApplication::UnicodeUTF8));
        BlobValue_text->setText(QApplication::translate("MainWindow", "0", 0, QApplication::UnicodeUTF8));
        ...
        radioButton->setText(QApplication::translate("MainWindow", "Less than", 0, QApplication::UnicodeUTF8));
        radioButton_2->setText(QApplication::translate("MainWindow", "More than", 0, QApplication::UnicodeUTF8));
